...
class TargetDatasetEval(data.Dataset):
    def __init__(self, split, cfg):
        ...
        self.cls2id = {'Car': 0, 'Pedestrian': 1, 'Cyclist': 2, 'Motorcycle': 2,
                       'Van': 3, 'Bus': 4, 'Truck': 5, 'Trailer': 5, 'BigCar': 5}
    ...
    def get_image(self, idx):
        jpg = os.path.join(self.image_dir, '%06d.jpg' % idx)
        png = os.path.join(self.image_dir, '%06d.png' % idx)
        img_file = jpg if os.path.exists(jpg) else png
