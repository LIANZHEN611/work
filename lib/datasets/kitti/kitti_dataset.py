...
from lib.datasets.utils import angle2class, angles2class, class2angles
...
class KITTI_Dataset(data.Dataset):
    def __init__(self, split, cfg):
        ...
        if self.dataset == 'carla':
            ...
            self.image_dir = os.path.join(self.data_dir, 'image_ss')
    ...
    def eval(self, results_dir, logger):
        ...
        test_id = {'Car': 0, 'Pedestrian': 1, 'Cyclist': 2, 'Van': 3, 'Bus': 4, 'BigCar': 5}
