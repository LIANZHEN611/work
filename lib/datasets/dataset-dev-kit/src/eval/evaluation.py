...
sys.path.append('/home/ubuntu/Projects/lz_project/WARM-3D/lib/datasets/dataset-dev-kit')
...
if __name__ == "__main__":
    ...
    #folder_path_ground_truth = '/data/tum_traffic_intersection_dataset_' + \
    #   camera_id + '/training/label_2'
    folder_path_ground_truth = '/home/ubuntu/Projects/lz_project/WARM-3D/data/s110_o_dataset/training/label_2'
    folder_path_predictions = output_dir

    object_min_points = 5
    use_superclasses = args.use_superclasses
    file_path_calibration_data = '/home/ubuntu/Projects/lz_project/WARM-3D/lib/datasets/dataset-dev-kit/calib/s110_camera_basler_' + \
                                 camera_id + '_8mm.json'
